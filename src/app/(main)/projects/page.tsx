    ...
    return (
      <Layout>
        <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh] px-6">
          <div className="app-soft-card w-full max-w-md p-10 text-center">
    ...
    return (
      <Layout>
        <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh] p-4 text-center">
          <div className="app-soft-card w-full max-w-md p-10">
    ...
    return (
      <Layout>
        <div className="app-topbar px-5 py-5 flex items-center sticky top-0 z-10 shadow-sm">
          <button onClick={() => setSelectedJobId(null)} className="mr-4 rounded-full p-2 text-white/70 hover:bg-white/8 hover:text-white">
            <ArrowLeft size={24} />
          </button>
          <h1 className="text-xl font-semibold tracking-[-0.02em] text-white truncate pr-4">
            {selectedJob.name}
          </h1>
        </div>

        <main className="flex-1 p-4 md:p-6 xl:p-4 pb-24 space-y-6 max-w-2xl md:max-w-none xl:max-w-2xl mx-auto">
          <div className="app-soft-card overflow-hidden">
  ...
  return (
    <Layout>
      <div className="app-topbar px-5 py-5 shadow-sm">
        <h1 className="text-xl font-semibold tracking-[-0.02em] text-white">Projects</h1>
      </div>
      ...
      <main className="flex-1 p-4 md:p-6 xl:p-4 space-y-3 pb-24 max-w-2xl md:max-w-none xl:max-w-2xl mx-auto">
        ...
        {projects?.map((job) => (
          <div
            ...
            className="app-flat-card p-4 active:bg-gray-50 transition-colors cursor-pointer"
          >
